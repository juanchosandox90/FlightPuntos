...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void updateDatabase(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 1) {
            ...
            insertAirline(db, "South West");


            //Bogota to Miami
            insertFlight(db, "Bogota", "Miami", "2019-8-10", "2019-8-10", "10:10", "12:10", 200.00, 1);
            insertFlight(db, "Bogota", "Miami", "2019-8-10", "2019-8-10", "10:10", "12:10", 150.00, 2);
            insertFlight(db, "Bogota", "Miami", "2019-8-10", "2019-8-10", "11:10", "12:10", 350.00, 3);
            insertFlight(db, "Bogota", "Miami", "2019-8-10", "2019-8-10", "09:10", "12:10", 250.00, 4);
            insertFlight(db, "Bogota", "Miami", "2019-8-10", "2019-8-10", "10:10", "12:10", 100.00, 5);

            //Miami to Bogota
            insertFlight(db, "Miami", "Bogota", "2019-8-12", "2019-8-12", "10:10", "12:10", 120.00, 6);
            insertFlight(db, "Miami", "Bogota", "2019-8-12", "2019-8-12", "09:00", "12:10", 150.00, 7);
            insertFlight(db, "Miami", "Bogota", "2019-8-12", "2019-8-12", "10:10", "12:10", 170.00, 8);
            insertFlight(db, "Miami", "Bogota", "2019-8-12", "2019-8-12", "09:00", "12:10", 140.00, 9);
            insertFlight(db, "Miami", "Bogota", "2019-8-12", "2019-8-12", "09:00", "12:10", 100.00, 10);
            insertFlight(db, "Miami", "Bogota", "2019-8-12", "2019-8-12", "10:10", "12:10", 350.00, 11);

            //Medellin to New York
            insertFlight(db, "Medellin", "New York", "2019-8-25", "2018-8-25", "02:00", "04:45", 300.00, 2);
            insertFlight(db, "Medellin", "New York", "2019-8-25", "2018-8-25", "01:00", "03:15", 205.00, 1);
            insertFlight(db, "Medellin", "New York", "2019-8-25", "2018-8-25", "09:00", "12:20", 350.00, 10);
            insertFlight(db, "Medellin", "New York", "2019-8-25", "2018-8-25", "08:00", "10:15", 400.00, 11);
            insertFlight(db, "Medellin", "New York", "2019-8-25", "2018-8-25", "11:00", "13:11", 250.00, 1);

            //New York to Medellin
            insertFlight(db, "New York", "Medellin", "2019-9-27", "2018-9-27", "11:00", "13:11", 300.00, 9);
            insertFlight(db, "New York", "Medellin", "2019-9-27", "2018-9-27", "09:00", "12:00", 250.00, 1);
            insertFlight(db, "New York", "Medellin", "2019-9-27", "2018-9-27", "08:00", "11:00", 400.00, 3);
            insertFlight(db, "New York", "Medellin", "2019-9-27", "2018-9-27", "01:00", "04:00", 150.00, 7);
            insertFlight(db, "New York", "Medellin", "2019-9-27", "2018-9-27", "12:00", "14:00", 350.00, 10);


            insertFlight(db, "Montreal", "Vancouver", "2019-7-28", "2019-7-28", "10:10", "12:10", 350.00, 4);
            insertFlight(db, "New York", "Miami", "2019-8-15", "2019-8-15", "09:10", "12:10", 185.00, 5);
            insertFlight(db, "Bogota", "New York", "2019-7-28", "2019-7-28", "11:10", "12:10", 250.00, 6);
            insertFlight(db, "Medellin", "Miami", "2019-8-25", "2019-8-25", "10:10", "12:10", 360.00, 7);
            insertFlight(db, "Los Angeles", "Seatle", "2019-8-26", "2019-8-26", "10:10", "12:10", 350.00, 8);
            insertFlight(db, "Cartagena", "Miami", "2019-8-27", "2019-8-27", "09:10", "12:10", 350.00, 9);
            insertFlight(db, "Cali", "New York", "2019-8-28", "2019-8-28", "10:10", "12:10", 350.00, 10);
    ...
    public static final String[] CITIES = new String[]{
            "Bogota", "Miami", "New York", "Seatle", "Medellin",
            "Vancouver", "Cali", "Cartagena", "Paris",
            "Madrid", "Barcelona", "", "Quebec", "Orlando", "Ft. Lauderdale", "Boston", "Los Angeles",
            "Montreal"
    };
}
